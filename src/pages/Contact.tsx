        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <AnimatedSection>
            <form onSubmit={handleSubmit} className="card-warrior p-6 md:p-8 space-y-5">
              {[
                { label: t("contact.name"), key: "name", type: "text", placeholder: t("contact.namePlaceholder") },
                { label: t("contact.email"), key: "email", type: "email", placeholder: "your@email.com" },
                { label: t("contact.phone"), key: "phone", type: "tel", placeholder: "+91 XXXXX XXXXX" },
              ].map((field) => (
                <div key={field.key}>
          ...
          <AnimatedSection delay={0.2}>
            <div className="space-y-6">
              <div className="card-warrior p-6">
                <h3 className="font-display font-bold text-foreground mb-4">{t("contact.contactInfo")}</h3>
              ...
              <div className="card-warrior overflow-hidden h-64">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59895.80828717!2d74.49!3d20.55!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdf28b3b4d5c58f%3A0x8c7d3a5f7e2e1a0!2sMalegaon%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1710000000000!5m2!1sen!2sin"
                  width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" title="Location Map"
                />
              </div>
              <div className="card-warrior p-6">
                <h3 className="font-display font-bold text-foreground mb-3">{t("contact.followUs")}</h3>
                <div className="flex gap-3">
                  {["Facebook", "Instagram", "YouTube", "Twitter"].map((s) => (
                    <a key={s} href="#" className="px-3 py-2 text-xs font-medium bg-muted rounded-md text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors">{s}</a>
                  ))}
                </div>
              </div>
            </div>
